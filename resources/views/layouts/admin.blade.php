...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Nav::isRoute('admin_incident_report_list') }}">
                <a class="nav-link" href="{{ route('admin_incident_report_list') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <script>
        ...
        document.getElementById('select-all').onclick = function() {
            var checkboxes = document.getElementsByName('scholar_id[]');
        ...
        $("#proceed_notify_student").on('submit', (function(e) {
            e.preventDefault();
            // $('.loading').show();
            // $('#hide_if_trigger').hide();
            $.ajax({
                url: "proceed_notify_student",
                type: "POST",
                ...
                success: function(data) {
                    ...
                    $('#notify_student_proceed').html(data);
                    // $('#hide_if_trigger').show();
                },
            });
        }));

        $("#notify_student_process").on('submit', (function(e) {
            e.preventDefault();
            // $('.loading').show();
            // $('#hide_if_trigger').hide();
            $.ajax({
                url: "notify_student_process",
                type: "POST",
                data: new FormData(this),
                contentType: false,
                cache: false,
                ...
                success: function(data) {
                    ...
                    //     position: 'top-end',
                    //     icon: 'success',
                    //     title: 'Student(s) notified successfully',
