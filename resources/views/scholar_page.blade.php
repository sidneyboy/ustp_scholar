    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="proceed_notify_student" method="post">
                    @csrf
                    <div class="card-body">
                        <a href="{{ url('scholar') }}" class="btn btn-sm float-right btn-info">+ New Scholar</a>
                        <br /><br />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade"
                                                    id="exampleModalPersonalinformation{{ $data->id }}" tabindex="-1"
